...
(0, _jquery2.default)(document).ready(function () {
    ...
    (0, _jquery2.default)('.c-card .form__check :checkbox').change(function () {
        (0, _jquery2.default)(this).parents('form').submit();
    });

    (0, _jquery2.default)('.c-btn__edit').on('click', function () {
        console.log('CLICKED!');
        (0, _jquery2.default)(this).parent('.c-card').addClass('c-card--hidden');
    });

    // Function to remove page message (Updated)
    var removeMessages = function removeMessages() {
        (0, _jquery2.default)('#pageMessage, #pageErrors').removeClass('mdl-snackbar--active');
    };
    // Remove page message after 5000 seconds
    if ((0, _jquery2.default)('#pageMessage, #pageErrors').hasClass('mdl-snackbar--active')) {
        setTimeout(removeMessages, 5000);
    }
});

},{"jquery":1,"material-design-lite/src/button/button.js":2,"material-design-lite/src/checkbox/checkbox.js":3,"material-design-lite/src/data-table/data-table.js":4,"material-design-lite/src/icon-toggle/icon-toggle.js":5,"material-design-lite/src/layout/layout.js":6,"material-design-lite/src/mdlComponentHandler.js":7,"material-design-lite/src/ripple/ripple.js":8,"material-design-lite/src/textfield/textfield.js":9,"material-design-lite/src/tooltip/tooltip.js":10}]},{},[11]);
